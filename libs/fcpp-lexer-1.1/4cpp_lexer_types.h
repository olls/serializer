...
static const char*
cpp_token_string(Cpp_Token& token)
{
    switch (token.type){
        case(CPP_TOKEN_JUNK):  return("CPP_TOKEN_JUNK");
        case(CPP_TOKEN_COMMENT):  return("CPP_TOKEN_COMMENT");

        case(CPP_PP_INCLUDE):  return("CPP_PP_INCLUDE");
        case(CPP_PP_DEFINE):  return("CPP_PP_DEFINE");
        case(CPP_PP_UNDEF):  return("CPP_PP_UNDEF");
        case(CPP_PP_IF):  return("CPP_PP_IF");
        case(CPP_PP_IFDEF):  return("CPP_PP_IFDEF");
        case(CPP_PP_IFNDEF):  return("CPP_PP_IFNDEF");
        case(CPP_PP_ELSE):  return("CPP_PP_ELSE");
        case(CPP_PP_ELIF):  return("CPP_PP_ELIF");
        case(CPP_PP_ENDIF):  return("CPP_PP_ENDIF");
        case(CPP_PP_ERROR):  return("CPP_PP_ERROR");
        case(CPP_PP_IMPORT):  return("CPP_PP_IMPORT");
        case(CPP_PP_USING):  return("CPP_PP_USING");
        case(CPP_PP_LINE):  return("CPP_PP_LINE");
        case(CPP_PP_PRAGMA):  return("CPP_PP_PRAGMA");
        case(CPP_PP_STRINGIFY):  return("CPP_PP_STRINGIFY");
        case(CPP_PP_CONCAT):  return("CPP_PP_CONCAT");
        case(CPP_PP_UNKNOWN):  return("CPP_PP_UNKNOWN");

        case(CPP_PP_DEFINED):  return("CPP_PP_DEFINED");
        case(CPP_PP_INCLUDE_FILE):  return("CPP_PP_INCLUDE_FILE");
        case(CPP_PP_ERROR_MESSAGE):  return("CPP_PP_ERROR_MESSAGE");

        case(CPP_TOKEN_KEY_TYPE):  return("CPP_TOKEN_KEY_TYPE");
        case(CPP_TOKEN_KEY_MODIFIER):  return("CPP_TOKEN_KEY_MODIFIER");
        case(CPP_TOKEN_KEY_QUALIFIER):  return("CPP_TOKEN_KEY_QUALIFIER");
        /* DOC(This type is not stored in token output from the lexer.) */
        case(CPP_TOKEN_KEY_OPERATOR):  return("CPP_TOKEN_KEY_OPERATOR");
        case(CPP_TOKEN_KEY_CONTROL_FLOW):  return("CPP_TOKEN_KEY_CONTROL_FLOW");
        case(CPP_TOKEN_KEY_CAST):  return("CPP_TOKEN_KEY_CAST");
        case(CPP_TOKEN_KEY_TYPE_DECLARATION):  return("CPP_TOKEN_KEY_TYPE_DECLARATION");
        case(CPP_TOKEN_KEY_ACCESS):  return("CPP_TOKEN_KEY_ACCESS");
        case(CPP_TOKEN_KEY_LINKAGE):  return("CPP_TOKEN_KEY_LINKAGE");
        case(CPP_TOKEN_KEY_OTHER):  return("CPP_TOKEN_KEY_OTHER");

        case(CPP_TOKEN_IDENTIFIER):  return("CPP_TOKEN_IDENTIFIER");
        case(CPP_TOKEN_INTEGER_CONSTANT):  return("CPP_TOKEN_INTEGER_CONSTANT");
        case(CPP_TOKEN_CHARACTER_CONSTANT):  return("CPP_TOKEN_CHARACTER_CONSTANT");
        case(CPP_TOKEN_FLOATING_CONSTANT):  return("CPP_TOKEN_FLOATING_CONSTANT");
        case(CPP_TOKEN_STRING_CONSTANT):  return("CPP_TOKEN_STRING_CONSTANT");
        case(CPP_TOKEN_BOOLEAN_CONSTANT):  return("CPP_TOKEN_BOOLEAN_CONSTANT");

        case(CPP_TOKEN_STATIC_ASSERT):  return("CPP_TOKEN_STATIC_ASSERT");

        case(CPP_TOKEN_BRACKET_OPEN):  return("CPP_TOKEN_BRACKET_OPEN");
        case(CPP_TOKEN_BRACKET_CLOSE):  return("CPP_TOKEN_BRACKET_CLOSE");
        case(CPP_TOKEN_PARENTHESE_OPEN):  return("CPP_TOKEN_PARENTHESE_OPEN");
        case(CPP_TOKEN_PARENTHESE_CLOSE):  return("CPP_TOKEN_PARENTHESE_CLOSE");
        case(CPP_TOKEN_BRACE_OPEN):  return("CPP_TOKEN_BRACE_OPEN");
        case(CPP_TOKEN_BRACE_CLOSE):  return("CPP_TOKEN_BRACE_CLOSE");
        case(CPP_TOKEN_SEMICOLON):  return("CPP_TOKEN_SEMICOLON");
        case(CPP_TOKEN_ELLIPSIS):  return("CPP_TOKEN_ELLIPSIS");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_STAR):  return("CPP_TOKEN_STAR");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_AMPERSAND):  return("CPP_TOKEN_AMPERSAND");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_TILDE):  return("CPP_TOKEN_TILDE");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_PLUS):  return("CPP_TOKEN_PLUS");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_MINUS):  return("CPP_TOKEN_MINUS");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_INCREMENT):  return("CPP_TOKEN_INCREMENT");

        /* DOC(This is an 'ambiguous' token type because it requires
        parsing to determine the full nature of the token.) */
        case(CPP_TOKEN_DECREMENT):  return("CPP_TOKEN_DECREMENT");

        // NOTE(allen): Precedence 1, LtoR
        case(CPP_TOKEN_SCOPE):  return("CPP_TOKEN_SCOPE");

        // NOTE(allen): Precedence 2, LtoR
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_POSTINC):  return("CPP_TOKEN_POSTINC");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_POSTDEC):  return("CPP_TOKEN_POSTDEC");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_FUNC_STYLE_CAST):  return("CPP_TOKEN_FUNC_STYLE_CAST");
        case(CPP_TOKEN_CPP_STYLE_CAST):  return("CPP_TOKEN_CPP_STYLE_CAST");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_CALL):  return("CPP_TOKEN_CALL");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_INDEX):  return("CPP_TOKEN_INDEX");
        case(CPP_TOKEN_DOT):  return("CPP_TOKEN_DOT");
        case(CPP_TOKEN_ARROW):  return("CPP_TOKEN_ARROW");

        // NOTE(allen): Precedence 3, RtoL

        /* DOC(This token is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_PREINC):  return("CPP_TOKEN_PREINC");
        /* DOC(This token is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_PREDEC):  return("CPP_TOKEN_PREDEC");
        /* DOC(This token is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_POSITIVE):  return("CPP_TOKEN_POSITIVE");
        /* DOC(This token is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_NEGAITVE):  return("CPP_TOKEN_NEGAITVE");
        case(CPP_TOKEN_NOT):  return("CPP_TOKEN_NOT");

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_BIT_NOT):  return("CPP_TOKEN_BIT_NOT");

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_CAST):  return("CPP_TOKEN_CAST");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_DEREF):  return("CPP_TOKEN_DEREF");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_TYPE_PTR):  return("CPP_TOKEN_TYPE_PTR");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_ADDRESS):  return("CPP_TOKEN_ADDRESS");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_TYPE_REF):  return("CPP_TOKEN_TYPE_REF");
        case(CPP_TOKEN_SIZEOF):  return("CPP_TOKEN_SIZEOF");
        case(CPP_TOKEN_ALIGNOF):  return("CPP_TOKEN_ALIGNOF");
        case(CPP_TOKEN_DECLTYPE):  return("CPP_TOKEN_DECLTYPE");
        case(CPP_TOKEN_TYPEID):  return("CPP_TOKEN_TYPEID");
        case(CPP_TOKEN_NEW):  return("CPP_TOKEN_NEW");
        case(CPP_TOKEN_DELETE):  return("CPP_TOKEN_DELETE");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_NEW_ARRAY):  return("CPP_TOKEN_NEW_ARRAY");
        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_DELETE_ARRAY):  return("CPP_TOKEN_DELETE_ARRAY");

        // NOTE(allen): Precedence 4, LtoR
        case(CPP_TOKEN_PTRDOT):  return("CPP_TOKEN_PTRDOT");
        case(CPP_TOKEN_PTRARROW):  return("CPP_TOKEN_PTRARROW");

        // NOTE(allen): Precedence 5, LtoR

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_MUL):  return("CPP_TOKEN_MUL");
        case(CPP_TOKEN_DIV):  return("CPP_TOKEN_DIV");
        case(CPP_TOKEN_MOD):  return("CPP_TOKEN_MOD");

        // NOTE(allen): Precedence 6, LtoR

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_ADD):  return("CPP_TOKEN_ADD");

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_SUB):  return("CPP_TOKEN_SUB");

        // NOTE(allen): Precedence 7, LtoR
        case(CPP_TOKEN_LSHIFT):  return("CPP_TOKEN_LSHIFT");
        case(CPP_TOKEN_RSHIFT):  return("CPP_TOKEN_RSHIFT");

        // NOTE(allen): Precedence 8, LtoR
        case(CPP_TOKEN_LESS):  return("CPP_TOKEN_LESS");
        case(CPP_TOKEN_GRTR):  return("CPP_TOKEN_GRTR");
        case(CPP_TOKEN_GRTREQ):  return("CPP_TOKEN_GRTREQ");
        case(CPP_TOKEN_LESSEQ):  return("CPP_TOKEN_LESSEQ");

        // NOTE(allen): Precedence 9, LtoR
        case(CPP_TOKEN_EQEQ):  return("CPP_TOKEN_EQEQ");
        case(CPP_TOKEN_NOTEQ):  return("CPP_TOKEN_NOTEQ");

        // NOTE(allen): Precedence 10, LtoR

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_BIT_AND):  return("CPP_TOKEN_BIT_AND");

        // NOTE(allen): Precedence 11, LtoR
        case(CPP_TOKEN_BIT_XOR):  return("CPP_TOKEN_BIT_XOR");

        // NOTE(allen): Precedence 12, LtoR
        case(CPP_TOKEN_BIT_OR):  return("CPP_TOKEN_BIT_OR");

        // NOTE(allen): Precedence 13, LtoR
        case(CPP_TOKEN_AND):  return("CPP_TOKEN_AND");

        // NOTE(allen): Precedence 14, LtoR
        case(CPP_TOKEN_OR):  return("CPP_TOKEN_OR");

        // NOTE(allen): Precedence 15, RtoL
        case(CPP_TOKEN_TERNARY_QMARK):  return("CPP_TOKEN_TERNARY_QMARK");
        case(CPP_TOKEN_COLON):  return("CPP_TOKEN_COLON");
        case(CPP_TOKEN_THROW):  return("CPP_TOKEN_THROW");
        case(CPP_TOKEN_EQ):  return("CPP_TOKEN_EQ");
        case(CPP_TOKEN_ADDEQ):  return("CPP_TOKEN_ADDEQ");
        case(CPP_TOKEN_SUBEQ):  return("CPP_TOKEN_SUBEQ");
        case(CPP_TOKEN_MULEQ):  return("CPP_TOKEN_MULEQ");
        case(CPP_TOKEN_DIVEQ):  return("CPP_TOKEN_DIVEQ");
        case(CPP_TOKEN_MODEQ):  return("CPP_TOKEN_MODEQ");
        case(CPP_TOKEN_LSHIFTEQ):  return("CPP_TOKEN_LSHIFTEQ");
        case(CPP_TOKEN_RSHIFTEQ):  return("CPP_TOKEN_RSHIFTEQ");
        case(CPP_TOKEN_ANDEQ):  return("CPP_TOKEN_ANDEQ");
        case(CPP_TOKEN_OREQ):  return("CPP_TOKEN_OREQ");
        case(CPP_TOKEN_XOREQ):  return("CPP_TOKEN_XOREQ");

        // NOTE(allen): Precedence 16, LtoR
        case(CPP_TOKEN_COMMA):  return("CPP_TOKEN_COMMA");

        /* DOC(This type is for parser use, it is not output by the lexer.) */
        case(CPP_TOKEN_EOF):  return("CPP_TOKEN_EOF");

        case(CPP_TOKEN_TYPE_COUNT):  return("CPP_TOKEN_TYPE_COUNT");
